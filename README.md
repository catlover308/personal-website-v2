...
## Built for [HCTG](https://game.hackclub.com/)
## Uses [astro](https://astro.build/) as a template
## Also uses [lenis](https://github.com/studio-freight/lenis) for smooth scrolling

This is my pretty much my first programming project, so it's kind of generic...
...
# AI Declaration:
I used [Antigravity](antigravity.google) as an IDE and integrated AI assistant to assist with explaining concepts, syntax, and steps to debug. 
